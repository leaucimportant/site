export const impactivFr = {
  ...
  'SPECIFIC-DEVELOPMENT-SHORT-DESCRIPTION':
    'Créer des outils métier à forte valeur ajoutée.',
  ...
  'OUR-SOLUTIONS-TITLE-PART-ONE': 'Plongez dans un écosystème',
  'OUR-SOLUTIONS-TITLE-PART-TWO': 'complet',
  'OUR-SOLUTIONS-TITLE-PART-THREE': 'et performant',
  'OUR-SOLUTIONS-DESCRIPTION':
    "Nos solutions sont intuitives, complémentaires, évolutives et sont le gage d'une digitalisation réussie et ambitieuse.",
  ...
  'OUR-SKILLS-UI': 'Designer avec un objectif.',
  ...
  'OUR-SKILLS-AGILE': 'Développement influencé par la méthode Agile.',
  ...
  'OUR-SKILLS-INFRASTRUCTURE': 'Infrastructure et back-end',
  ...
  'DSM-EXPERTISE-TITLE': 'Notre expertise',
  'DSM-EXPERTISE-METHODOLOGIES': 'Méthodologies',
  'DSM-EXPERTISE-METHODOLOGIES-SPECIFICATIONS':
    'Cahier des charges et recettages',
  'DSM-EXPERTISE-METHODOLOGIES-CI': 'Intégration continue',
  'DSM-EXPERTISE-METHODOLOGIES-CD': 'Déploiement continu',
  'DSM-EXPERTISE-METHODOLOGIES-TEST': 'Tests unitaires et fonctionnels',
  'DSM-EXPERTISE-METHODOLOGIES-PRIVACY':
    'Privacy by Design & Privacy by Default',
  'DSM-EXPERTISE-DEVELOPMENTS': 'Développements',
  'DSM-EXPERTISE-DEVELOPMENTS-FRONT': 'Développement Frontend',
  'DSM-EXPERTISE-DEVELOPMENTS-BACK': 'Développement Backend',
  'DSM-EXPERTISE-DEVELOPMENTS-PWA': 'Progressive Web App',
  'DSM-EXPERTISE-DEVELOPMENTS-NATIVE': 'Applications natives',
  ...
  'DSM-EXPERTISE-TECHNOLOGIES-BDD': 'BDD relationnelle & orientée documents',
  'DSM-EXPERTISE-TECHNOLOGIES-MESSAGE': 'Agent de messages',
  ...
  'COMPANY-SKILLS-TITLE': 'Une équipe dédiée à chacun de vos besoins.',
  'COMPANY-SKILLS-DESIGN': 'Design',
  'COMPANY-SKILLS-UX-UI': 'UX & UI',
  'COMPANY-SKILLS-ART': 'Direction artistique',
  'COMPANY-SKILLS-MOTION': 'Motion',
  'COMPANY-SKILLS-PRINT': 'Print',
  'COMPANY-SKILLS-DEVELOPMENT': 'Développement',
  'COMPANY-SKILLS-PWA': 'PWA & App Native',
  'COMPANY-SKILLS-SERVERLESS': 'Serverless & CaaS',
  'COMPANY-SKILLS-INFRASTRUCTURE': 'Infrastructure',
  'COMPANY-SKILLS-CLOUD': 'Cloud & Sur Site',
  'COMPANY-SKILLS-IAC': 'IaC',
  'COMPANY-SKILLS-AGILE': 'Agile',
  'COMPANY-SKILLS-CONTACT': 'Interlocuteurs dédiés',
  'COMPANY-SKILLS-CREATION': 'Co-création',
  'CONTACT-TITLE': 'Contactez nos experts',
  'CONTACT-DESCRIPTION':
    "Une demande d'information, de présentation ou démonstration de nos solutions, un dépôt de candidature, une suggestion ou un commentaire relatif à notre site, ce formulaire est fait pour vous !",
  'CONTACT-CALL-US': 'Appelez-nous',
  'CONTACT-GO-LK': 'Retrouvez-nous sur Linkedin',
  'CONTACT-SUBJECT': 'Objet de votre demande',
  'CONTACT-SUBJECT-PARTNERSHIP': 'Proposer un partenariat',
  'CONTACT-SUBJECT-POSTULATE': 'Postuler',
  'CONTACT-SUBJECT-DISCUSS': 'Echanger sur un projet',
  'CONTACT-SUBJECT-DEMO': 'Demander une démo',
  'CONTACT-SUBJECT-HOTLINE': 'Une demande SAV / hotline',
  'CONTACT-SUBJECT-OTHER': 'Autre',
  'CONTACT-SUBJECT-ERROR': "Veuillez sélectionner l'objet de votre demande.",
  'CONTACT-NAME': 'Nom et Prénom',
  'CONTACT-NAME-ERROR': 'Veuillez saisir un nom valide',
  'CONTACT-COMPANY': 'Société',
  'CONTACT-PHONE': 'Téléphone',
  'CONTACT-PHONE-ERROR': 'Veuillez saisir un numéro valide',
  'CONTACT-EMAIL': 'Email professionnel',
  'CONTACT-EMAIL-EXAMPLE': 'exemple@gmail.com',
  'CONTACT-EMAIL-ERROR': 'Veuillez saisir un email valide',
  'CONTACT-MESSAGE': 'Comment pouvons-nous vous aider ?',
  'CONTACT-MESSAGE-EXAMPLE': 'Votre message...',
  'CONTACT-SEND-FORM': 'Envoyer le message',
  'CONTACT-RECAPTCHA-ONE': 'Ce site est protégé par reCAPTCHA et par',
  'CONTACT-RECAPTCHA-TWO': 'les règles de confidentialité de Google',
  'CONTACT-RECAPTCHA-THREE': 'Les conditions de service',
  'CONTACT-RECAPTCHA-FOUR': "s'appliquent.",
  'CONTACT-SUCCESS-RESPONSE': 'Votre message a bien été envoyé',
  'CONTACT-CONTINUE': 'Continuer',
  'CONTACT-TRY-AGAIN': 'Essayer à nouveau',
  'CONTACT-MANY-TRY': "Trop d'essais. Veuillez réessayer plus tard",
  'CONTACT-ERROR-SERVER': 'Erreur Serveur. Veuillez réessayer plus tard',
  'NOT-FOUND-TITLE': 'Erreur 404',
